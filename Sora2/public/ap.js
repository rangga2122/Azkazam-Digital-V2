...
(function() {
    ...
    function Ve(e, t) {
        ...
        function f(d) {
            ...
            n; )
                try {
                    if (o = 1,
                    c && (l = d[0] & 2 ? c.return : d[0] ? c.throw || ((l = c.return) && l.call(c),
                    0) : c.next) && !(l = l.call(c, d[1])).done)
                        return l;
                    switch (c = 0,
                    l && (d = [d[0] & 2, l.value]),
                    d[0]) {
    ...
    function pt(e, t, n) {
        var o = "https://challenges.cloudflare.com", c, l = (c = n == null ? void 0 : n.origin) !== null && c !== void 0 ? c : o;
        if (t) {
            var g;
    ...
    var ht = function(e, t, n, o) {
        var c = pt(t.params, !1, o), l = "h/".concat("b", "/"), g, y, f = "".concat(c, "/cdn-cgi/challenge-platform/").concat(l, "feedback-reports/").concat(Ge(e), "/").concat(t.displayLanguage, "/").concat((y = t.params.theme) !== null && y !== void 0 ? y : t.theme, "/").concat(n);
    ...
    function zr(e) {
        ...
        try {
            for (var c = e.widgetMap[Symbol.iterator](), l; !(t = (l = c.next()).done); t = !0) {
                var g = Ce(l.value, 2), y = g[0], f = g[1], d;
    ...
    function Hr(e) {
        ...
        if (!(t === void 0 || t.hasResponseParamEl)) {
            ...
            if (o) {
                ...
                c.type = "hidden";
                var l;
                c.name = (l = t.params["response-field-name"]) !== null && l !== void 0 ? l : st,
                ...
                if (typeof t.params["response-field-name"] != "string" && Cr((g = t.params.sitekey) !== null && g !== void 0 ? g : "")) {
                    ...
                    y.type = "hidden",
                    y.name = lt,
                    y.id = "".concat(e, "_legacy_response"),
                    t.wrapper.appendChild(y)
                }
            }
    ...
    var Vt = (function() {
        var e = function(a, i, r, u) {
          ...
          , n = function(a, i, r) {
            ...
            a.isComplete = !0,
            Ir(i, a.response),
            (u = a.cbSuccess) === null || u === void 0 || u.call(a, a.response, r)
        }
          , o = function(a) {
            if (!a)
                return [];
            for (var i = a.attributes, r = i.length, u = new Array(r), s = 0; s < r; s++)
                u[s] = i[s].name;
            return u
        }
          , c = function(a, i, r) {
          ...
          , w = function(a, i) {
            ...
            if (u) {
                ...
                u.watchcat.seq = 0,
                u.params.execution === he.Render && (u.msgQueue.push(ce.Execute),
                u.isExecuted = !0,
                u.isExecuting = !0);
                var h = J(r)
                  , x = u.shadow.querySelector("#".concat(h));
                (!h || !x) && v("Widget ".concat(r, " to reset was not found."), 3330),
                u.params.appearance === $.InteractionOnly && Sr(x),
                u.params.sitekey === null && v("Unexpected Error: Sitekey is null", 3347);
                var E = x.cloneNode(), I;
                E.src = vt(r, u.params.sitekey, u.params, (I = u.rcV) !== null && I !== void 0 ? I : Q, !1, "b", a, m.scriptUrlParsed, ut(u)),
          ...
          , C = function(a, i) {
            ...
            if (typeof a == "string")
                ...
                V(a, HTMLElement) ? h = a : v('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            var E = !0
              , I = !1
              , O = void 0;
            try {
            ...
            if (le) {
                ...
                Rt(p.size) || v('Invalid type for parameter "size", expected normal|compact, got "'.concat(p.size, '" ').concat(D(p.size)), 3590),
                ...
                if (!(!Ie || !ve)) {
                    ...
                    B.setAttribute("src", vt(Ie, q, p, Q, !1, "b", H.New, m.scriptUrlParsed, ut(tt))),
                    B.onerror = function() {
                        if (ie) {
                    ...
                    F((rt = (u = document.featurePolicy) === null || u === void 0 || (r = u.features) === null || r === void 0 ? void 0 : r.call(u)) !== null && rt !== void 0 ? rt : [], ft) && qt.push(ft),
            ...
            return k = Ht(function(_, a, i, r) {
                ...
                return Ve(this, function(W) {
                    ...
                    case 0:
                        ...
                        E = "https",
                        I = "",
                        P = "".concat(E, "://").concat(x.host, "/cdn-cgi/challenge-platform/").concat(h, "rc/").concat(r).concat(I),
                        W.label = 1;
                    case 1:
                        ...
                        case "init":
                            {
                                ...
                                h || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                        ...
                        case "fail":
                            {
                                ...
                                if (P) {
                                    var le;
                                    P(String((le = a.code) !== null && le !== void 0 ? le : Zt)) ? r.params.retry === ge.Auto && !r.isResetting && t(r, i, G) : (a.code && b("Error: ".concat(a.code, ".")),
                                    t(r, i, G))
                                } else
                                    a.code ? (t(r, i, G),
                        ...
                        case "requestExtraParams":
                            {
                                ...
                                Se || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                r.isResetting = !1;
                                var ie = {}
                                  , Ke = j()
                                  , Ae = {
        ...
        return ot(Pe({}, N), {
            ...
            execute: function(a, i) {
                ...
                if (!r) {
                    ...
                    var u = C(a, i);
                    u || v("Failed to render widget", 43522),
                    r = u
                }
                ...
                if (s) {
                    ...
                    s.response) {
                        var x;
                        s.isExecuting = !1,
                        b("Call to execute() on a widget that was already executed (".concat(h, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                        (x = s.cbSuccess) === null || x === void 0 || x.call(s, s.response, !1);
                        return
                    }
                    s.isExpired && b("Call to execute on a expired-widget (".concat(h, "), consider using reset() before.")),
                    s.isStale && (w(H.StaleExecute, h),
                    s.isExecuting = !0),
                    s.msgQueue.push(ce.Execute),
                    s.isExecuted = !0;
                    var E = s.shadow.querySelector("#".concat(h));
                    if (E || (s.isExecuting = !1,
                    v("Widget ".concat(h, " to execute was not found"), 43522)),
                    s.isResetting)
                        return;
                    if (s.isInitialized && y(s, r, E),
            ...
            getResponse: function(a) {
                ...
                if (typeof a == "undefined") {
                    ...
                    if (r) {
                        ...
                        (u = m.widgetMap.get(r)) === null || u === void 0 ? void 0 : u.response
                    }
                    v("Could not find a widget", 43794)
                }
                var h = S(a);
                return h || v("Could not find widget for provided container", 43778),
                (i = m.widgetMap.get(h)) === null || i === void 0 ? void 0 : i.response
            },
            implicitRender: Pt,
    ...
    function Yr(e) {
        ...
        if (l && (Rt(l) ? n.size = l : b('Unknown data-size value: "'.concat(l, '".'))),
        0)
            var g;
        ...
        return h && (Ct(h) ? n.appearance = h : b('Unknown data-appearance value: "'.concat(h, ", expected either: 'always', 'execute', or 'interaction-only'."))),
        n
    }
    function Qr() {
        var e = !0;
    ...
    ye = A.params.get("_upgrade") === "true",
    X = A.params.get("onload"),
    X && !ye && setTimeout(function() {
    ...
    Dt && !ye ? b("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Dt && ye && (wr(window.turnstile, m),
    kt(m),
    (A == null || ($e = A.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit" && setTimeout(Pt, 0)),
    window.turnstile = Vt,
    ye || ((A == null || (Je = A.params) === null || Je === void 0 ? void 0 : Je.get("render")) !== "explicit" && Wt.push(Pt),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(Rr, 0) : window.addEventListener("DOMContentLoaded", Rr))),
    Ar = 1440 * 60 * 1e3,
    window.setTimeout(Qr, Ar);
